      ...
      <div className="space-y-3">
        ...
        <button onClick={() => onNavigate('builder')} className="w-full glass-card p-4 flex items-center gap-3 hover:bg-white/10 transition-colors active:scale-[0.98]">
          ...
          <div className="text-left flex-1 min-w-0">
            ...
            <p className="text-white/60 text-xs sm:text-sm">Create an app from your idea</p>
          </div>
        </button>
      ...
      <div className="glass-card p-4 sm:p-6 space-y-3">
        ...
        <ul className="space-y-2 text-xs sm:text-sm text-white/60">
          <li className="flex items-start gap-2">
            ...
            <span>Describe your app idea in the Builder tab</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-orange-500 mt-0.5">2.</span>
            <span>AI generates your app structure and code</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-orange-500 mt-0.5">3.</span>
            <span>Preview and export your app</span>
          </li>
        </ul>
      </div>
    </div>
