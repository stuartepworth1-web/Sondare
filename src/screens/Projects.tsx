    ...
    <div className="min-h-screen pb-24 p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 sm:py-16 space-y-4 px-4">
          ...
          <button className="accent-button px-5 sm:px-6 py-2.5 sm:py-3 flex items-center gap-2 text-sm sm:text-base">
          ...
          {projects.map((project) => (
            <div key={project.id} className="glass-card p-4 sm:p-5 space-y-3 sm:space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex-1 glass-button py-2 flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm active:scale-95">
